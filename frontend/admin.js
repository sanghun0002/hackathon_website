...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    const fetchAllBookings = async () => {
        ...
        return [
            { date: "2025-08-27", region: "경상북도", valley: "무흘 계곡", section: "제1곡 봉비암", deck: "평상 1", name: "홍길동", phone: "010-1234-5678" },
            { date: "2025-08-28", region: "경상북도", valley: "무흘 계곡", section: "제1곡 봉비암", deck: "평상 2", name: "김철수", phone: "010-9876-5432" },
            { date: "2025-08-27", region: "경상북도", valley: "무흘 계곡", section: "제2곡 한강대", deck: "평상 1", name: "이영희", phone: "010-1111-2222" },
            { date: "2025-08-29", region: "경상북도", valley: "삼계리 계곡", section: "삼계리 1구역", deck: "평상 3", name: "박민준", phone: "010-3333-4444" },
            { date: "2025-08-27", region: "경기도", valley: "송추 계곡", section: "1구역", deck: "평상 2", name: "최은지", phone: "010-5555-6666" },
            { date: "2025-08-28", region: "경기도", valley: "송추 계곡", section: "1구역", deck: "평상 1", name: "강현우", phone: "010-7777-8888" },
            { date: "2025-08-29", region: "경기도", valley: "용추 계곡", section: "A구역", deck: "평상 1", name: "서지민", phone: "010-9999-0000" },
            // Add more mock data for pagination testing
            { date: "2025-08-27", region: "경상북도", valley: "무흘 계곡", section: "제1곡 봉비암", deck: "평상 3", name: "장민지", phone: "010-1234-1234" },
            { date: "2025-08-28", region: "경상북도", valley: "무흘 계곡", section: "제2곡 한강대", deck: "평상 2", name: "오동민", phone: "010-5678-5678" },
            { date: "2025-08-29", region: "경상북도", valley: "삼계리 계곡", section: "삼계리 1구역", deck: "평상 1", name: "김동건", phone: "010-1122-3344" },
            { date: "2025-08-29", region: "경기도", valley: "어비 계곡", section: "B구역", deck: "평상 1", name: "유재석", phone: "010-4455-6677" },
            { date: "2025-08-29", region: "경기도", valley: "어비 계곡", section: "B구역", deck: "평상 2", name: "노홍철", phone: "010-8899-0011" },
            { date: "2025-08-29", region: "강원도", valley: "무릉 계곡", section: "1구역", deck: "평상 4", name: "박명수", phone: "010-2233-4455" },
            { date: "2025-08-29", region: "강원도", valley: "흥정 계곡", section: "A구역", deck: "평상 1", name: "정준하", phone: "010-6677-8899" }
        ];
    };
    ...
    const populateFilterOptions = (options) => {
        ...
        // This is simplified. In a real app, section options would be dynamic based on region/valley.
    ...
    const applyFilters = () => {
        ...
        filteredBookings = allBookings.filter(booking => {
            ...
            return matchesDate && matchesRegion && matchesSection && matchesName;
        });
