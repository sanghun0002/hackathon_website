  ...
  const deckData = {
    ...
    "제3곡 무학정": {
      ...
      decks: [
        ...
        { id: "muhuel3-3", name: "평상 3", top: "50%", left: "41%", width: "7%", height: "6%", capacity: 4, isBooked: false },
        { id: "muhuel3-4", name: "평상 4", top: "50.5%", left: "59%", width: "7%", height: "6%", capacity: 4, isBooked: false },
