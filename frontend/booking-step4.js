document.addEventListener('DOMContentLoaded', () => {
  ...
  const deckData = {
    ...
    "제3곡 무학정": {
      ...
      decks: [
        { id: "muhuel3-1", name: "평상 1", top: "50%", left: "20%", width: "6%", height: "6%", capacity: 4, isBooked: false },
        { id: "muhuel3-2", name: "평상 2", top: "50%", left: "30%", width: "6%", height: "6%", capacity: 4, isBooked: false },
        { id: "muhuel3-3", name: "평상 3", top: "50%", left: "40%", width: "6%", height: "6%", capacity: 4, isBooked: false },
        { id: "muhuel3-4", name: "평상 4", top: "50%", left: "60%", width: "6%", height: "6%", capacity: 4, isBooked: false },
        { id: "muhuel3-5", name: "평상 5", top: "50%", left: "70%", width: "6%", height: "6%", capacity: 8, isBooked: false },
        { id: "muhuel3-6", name: "평상 6", top: "50%", left: "80%", width: "6%", height: "6%", capacity: 8, isBooked: false }
      ]
    }
  };
