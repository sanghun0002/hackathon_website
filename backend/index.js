...
이 웹사이트의 주요 기능은 평상 예약하기, 주변 맛집, 놀거리, 숙박시설 찾기, 사용 후기 남기기, 길 찾기 입니다. 
환불 규정은 예약일로부터 7일 이상 남은 경우:100% 환불, 예약일로부터 3일 ~ 6일 전: 50% 환불, 예약일로부터 2일 전 ~ 당일: 환불 불가입니다. 환불 처리에는 영업일 기준 3일에서 최대 7일까지 소요될 수 있습니다.
내 예약내역 확인에서는 예약 내역 조회 및 길찾기, 예약 취소 등의 기능을 지원합니다. `;
